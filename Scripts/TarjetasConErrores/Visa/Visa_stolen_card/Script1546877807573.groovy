...
WebUI.setText(findTestObject('Tarjetas/Page_Chazki/Numero_Tarjeta'), '4000 0200 0000 0000')

WebUI.setText(findTestObject('Tarjetas/Page_Chazki/CVV'), '354')

WebUI.setText(findTestObject('Tarjetas/Page_Chazki/Mes'), '10')

WebUI.setText(findTestObject('Tarjetas/Page_Chazki/Year'), '2019')
