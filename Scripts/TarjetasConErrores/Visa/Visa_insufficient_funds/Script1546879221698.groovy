...
WebUI.setText(findTestObject('Tarjetas/Page_Chazki/Numero_Tarjeta'), '4000 0400 0000 0008')

WebUI.setText(findTestObject('Tarjetas/Page_Chazki/CVV'), '295')

WebUI.setText(findTestObject('Tarjetas/Page_Chazki/Mes'), '03')
