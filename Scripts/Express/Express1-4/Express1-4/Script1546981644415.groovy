...
WebUI.setText(findTestObject('LoginMario/LoginPage_Chazki/input_envos_emailLogin'), 'kalu@gmail.com')
...
WebUI.verifyElementText(findTestObject('Express_Chazki/span_luis chavez'), 'kalu kalu')

WebUI.delay(5)

WebUI.sendKeys(findTestObject('Express_Chazki/Recojo/ContactoRecojo'), 'NICO PEÑA')
...
WebUI.takeScreenshot('C:\\Users\\Administrator\\Desktop\\CAPTURA EXPRESS\\express1-4-ORDEN.png')
...
WebUI.takeScreenshot('C:\\Users\\Administrator\\Desktop\\CAPTURA EXPRESS\\express1-4envios.png')
