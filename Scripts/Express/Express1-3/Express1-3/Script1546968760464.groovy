...
WebUI.setText(findTestObject('LoginMario/LoginPage_Chazki/input_envos_emailLogin'), 'kanu@gmail.com')
...
WebUI.verifyElementText(findTestObject('Express_Chazki/span_luis chavez'), 'kanu kanu')

WebUI.delay(5)

WebUI.sendKeys(findTestObject('Express_Chazki/Recojo/ContactoRecojo'), 'erika')
...
WebUI.takeScreenshot('C:\\Users\\Administrator\\Desktop\\CAPTURA EXPRESS\\express1-3-orden.png')
...
WebUI.takeScreenshot('C:\\Users\\Administrator\\Desktop\\CAPTURA EXPRESS\\express1-3-envios.png')
