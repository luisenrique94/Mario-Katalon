...
WebUI.setText(findTestObject('LoginMario/LoginPage_Chazki/input_envos_emailLogin'), 'ave@gmail.com')
...
WebUI.verifyElementText(findTestObject('Express_Chazki/span_luis chavez'), 'ave ave')
...
WebUI.click(findTestObject('MercadoPago/Lili-Visa'))
